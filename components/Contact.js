...
const Contact = () => {
  return (
    <div>
        ...
        <div className="bg-violet-400 container py-16 md:py-20  " id="contact">
              ...
              <div className="invert flex flex-col pt-16 lg:flex-row">
                <div className="w-full border-l-2 border-t-2 border-r-2 border-b-2 border-grey-60 px-6 py-6 sm:py-8 lg:w-1/3">
                  ...
                  <p className="invert pt-2 text-left font-body font-bold text-primary lg:text-lg">
                    100
                  </p>
                </div>
                ...
                <div className="w-full border-l-2 border-t-0 border-r-2 border-b-2 border-grey-60 px-6 py-6 sm:py-8 lg:w-1/3 lg:border-l-0 lg:border-t-2">
                  ...
                  <p className="pt-2 invert text-left font-body font-bold text-primary lg:text-lg">
                    I Cannot Tell You Bro
                  </p>
                </div>
              </div>
            </div>
